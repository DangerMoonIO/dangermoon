...
contract DangerMoonMultiBuy is Ownable {
    ...
    receive() external payable {
        dangerMoonMultiBuy(maxBuysPerTx);
    }

    function dangerMoonMultiBuy(uint8 numBuys) payable public {
        // user pays in multiples of minimum-entry-price PLUS the commission/gas costs
        ...
        uint256 amountOutMin = IDangerMoon(dangermoonAddress)._minimumTokensForReflection().div(10).mul(9);
